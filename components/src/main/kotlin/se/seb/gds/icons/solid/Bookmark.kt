    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                curveTo(x1 = 4.0f, y1 = 21.5153f, x2 = 4.14021f, y2 = 21.7609f, x3 = 4.36871f, y3 = 21.8958f)
                curveTo(x1 = 4.5972f, y1 = 22.0307f, x2 = 4.87998f, y2 = 22.0349f, x3 = 5.11231f, y3 = 21.9067f)
                lineTo(x = 12.0f, y = 18.1066f)
                lineTo(x = 18.8877f, y = 21.9067f)
                curveTo(x1 = 19.12f, y1 = 22.0349f, x2 = 19.4028f, y2 = 22.0307f, x3 = 19.6313f, y3 = 21.8958f)
                curveTo(x1 = 19.8598f, y1 = 21.7609f, x2 = 20.0f, y2 = 21.5153f, x3 = 20.0f, y3 = 21.25f)
