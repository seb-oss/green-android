...
val LineChartThree: ImageVector
    get() {
        ...
        return ImageVector
            .Builder(
                ...
                path(
                    ...
                    moveTo(x = 8.91602f, y = 12.75f)
                    lineTo(x = 8.91602f, y = 19.25f)
                    moveTo(x = 15.082f, y = 8.75f)
                    verticalLineTo(y = 19.25f)
                    moveTo(x = 21.248f, y = 4.75f)
                    verticalLineTo(y = 19.25f)
                }
            }.build()
            .also { _lineChartThree = it }
    }
