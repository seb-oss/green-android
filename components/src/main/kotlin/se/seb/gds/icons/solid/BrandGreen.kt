    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                curveTo(x1 = 8.70001f, y1 = 4.7f, x2 = 6.60001f, y2 = 3.1f, x3 = 4.30001f, y3 = 2.2f)
                lineTo(x = 3.70001f, y = 2.0f)
                lineTo(x = 3.50001f, y = 2.5f)
                curveTo(x1 = 2.60001f, y1 = 3.9f, x2 = 2.10001f, y2 = 5.5f, x3 = 2.00001f, y3 = 7.2f)
                curveTo(x1 = 1.90001f, y1 = 8.9f, x2 = 2.30001f, y2 = 10.5f, x3 = 3.00001f, y3 = 12.1f)
                curveTo(x1 = 3.70001f, y1 = 13.6f, x2 = 4.80001f, y2 = 14.9f, x3 = 6.20001f, y3 = 15.8f)
                curveTo(x1 = 7.50001f, y1 = 16.8f, x2 = 9.10001f, y2 = 17.4f, x3 = 10.7f, y3 = 17.5f)
