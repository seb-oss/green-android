        ...
        return ImageVector
            .Builder(
                ...
                path(
                    ...
                    moveTo(x = 8.66527f, y = 2.0f)
                    curveTo(x1 = 6.82527f, y1 = 2.0f, x2 = 5.33193f, y2 = 3.49333f, x3 = 5.33193f, y3 = 5.33333f)
                    curveTo(x1 = 5.33193f, y1 = 7.16852f, x2 = 6.81745f, y2 = 8.65884f, x3 = 8.65082f, y3 = 8.66664f)
                    curveTo(x1 = 6.81747f, y1 = 8.67445f, x2 = 5.33195f, y2 = 10.1648f, x3 = 5.33195f, y3 = 11.9999f)
                    curveTo(x1 = 5.33195f, y1 = 13.8399f, x2 = 6.82529f, y2 = 15.3333f, x3 = 8.66529f, y3 = 15.3333f)
                    ...
                    close()
                    moveTo(x = 15.3114f, y = 8.66667f)
                    horizontalLineTo(x = 11.9986f)
                    verticalLineTo(y = 11.9794f)
                    curveTo(x1 = 12.0096f, y1 = 10.1557f, x2 = 13.4876f, y2 = 8.67769f, x3 = 15.3114f, y3 = 8.66667f)
                    close()
                }
                path(
                    fill = SolidColor(Color(0xFF000000)),
                ) {
                    moveTo(x = 8.66529f, y = 22.0f)
                    curveTo(x1 = 10.5053f, y1 = 22.0f, x2 = 11.9986f, y2 = 20.5067f, x3 = 11.9986f, y3 = 18.6667f)
                    verticalLineTo(y = 15.3333f)
                    horizontalLineTo(x = 8.66529f)
                    curveTo(x1 = 6.82529f, y1 = 15.3333f, x2 = 5.33195f, y2 = 16.8267f, x3 = 5.33195f, y3 = 18.6667f)
                    curveTo(x1 = 5.33195f, y1 = 20.5067f, x2 = 6.82529f, y2 = 22.0f, x3 = 8.66529f, y3 = 22.0f)
                    close()
                }
            }.build()
            .also { _brandFigma = it }
