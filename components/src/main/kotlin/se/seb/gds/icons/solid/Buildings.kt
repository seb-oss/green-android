        ...
        return ImageVector
            .Builder(
                ...
                path(
                    ...
                    curveTo(x1 = 20.6642f, y1 = 7.25f, x2 = 21.0f, y2 = 7.58579f, x3 = 21.0f, y3 = 8.0f)
                    ...
                    curveTo(x1 = 7.0f, y1 = 8.33579f, x2 = 7.33579f, y2 = 8.0f, x3 = 7.75f, y3 = 8.0f)
                    horizontalLineTo(x = 10.25f)
                    curveTo(x1 = 10.6642f, y1 = 8.0f, x2 = 11.0f, y2 = 8.33579f, x3 = 11.0f, y3 = 8.75f)
                    curveTo(x1 = 11.0f, y1 = 9.16421f, x2 = 10.6642f, y2 = 9.5f, x3 = 10.25f, y3 = 9.5f)
                    horizontalLineTo(x = 7.75f)
                    curveTo(x1 = 7.33579f, y1 = 9.5f, x2 = 7.0f, y2 = 9.16421f, x3 = 7.0f, y3 = 8.75f)
                    close()
                    moveTo(x = 7.0f, y = 12.75f)
                    curveTo(x1 = 7.0f, y1 = 12.3358f, x2 = 7.33579f, y2 = 12.0f, x3 = 7.75f, y3 = 12.0f)
                    horizontalLineTo(x = 10.25f)
                    curveTo(x1 = 10.6642f, y1 = 12.0f, x2 = 11.0f, y2 = 12.3358f, x3 = 11.0f, y3 = 12.75f)
                    curveTo(x1 = 11.0f, y1 = 13.1642f, x2 = 10.6642f, y2 = 13.5f, x3 = 10.25f, y3 = 13.5f)
                    horizontalLineTo(x = 7.75f)
                    curveTo(x1 = 7.33579f, y1 = 13.5f, x2 = 7.0f, y2 = 13.1642f, x3 = 7.0f, y3 = 12.75f)
                    close()
                }
            }.build()
            .also { _buildings = it }
