...
val DotGridTwo: ImageVector
    get() {
        val current = _dotGridTwo
        if (current != null) return current

        return ImageVector.Builder(
            name = "se.seb.gds.theme.GdsTheme.DotGridTwo",
...
private var _dotGridTwo: ImageVector? = null
