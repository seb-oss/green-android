    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                curveTo(x1 = 11.8232f, y1 = 7.51256f, x2 = 11.8232f, y2 = 7.98744f, x3 = 11.5303f, y3 = 8.28033f)
                ...
                curveTo(x1 = 11.8232f, y1 = 16.0126f, x2 = 11.8232f, y2 = 16.4874f, x3 = 11.5303f, y3 = 16.7803f)
                curveTo(x1 = 11.2374f, y1 = 17.0732f, x2 = 10.7626f, y2 = 17.0732f, x3 = 10.4697f, y3 = 16.7803f)
                lineTo(x = 6.21967f, y = 12.5303f)
                curveTo(x1 = 6.07902f, y1 = 12.3897f, x2 = 6.0f, y2 = 12.1989f, x3 = 6.0f, y3 = 12.0f)
                curveTo(x1 = 6.0f, y1 = 11.8011f, x2 = 6.07902f, y2 = 11.6103f, x3 = 6.21967f, y3 = 11.4697f)
                lineTo(x = 10.4697f, y = 7.21967f)
                curveTo(x1 = 10.7626f, y1 = 6.92678f, x2 = 11.2374f, y2 = 6.92678f, x3 = 11.5303f, y3 = 7.21967f)
                close()
            }
        }.build().also { _arrowWallLeft = it }
    }
