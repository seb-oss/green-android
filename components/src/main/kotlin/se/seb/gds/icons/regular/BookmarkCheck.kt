    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                close()
                moveTo(x = 9.88033f, y = 9.81967f)
                curveTo(x1 = 9.58743f, y1 = 9.52677f, x2 = 9.11256f, y2 = 9.52677f, x3 = 8.81967f, y3 = 9.81967f)
                ...
                lineTo(x = 12.0f, y = 17.0f)
                close()
                moveTo(x = 9.35f, y = 10.35f)
                lineTo(x = 8.81967f, y = 10.8803f)
                lineTo(x = 10.4697f, y = 12.5303f)
                lineTo(x = 11.0f, y = 12.0f)
                lineTo(x = 11.5303f, y = 11.4697f)
                lineTo(x = 9.88033f, y = 9.81967f)
                lineTo(x = 9.35f, y = 10.35f)
                close()
                moveTo(x = 11.0f, y = 12.0f)
                lineTo(x = 11.5303f, y = 12.5303f)
                lineTo(x = 15.3803f, y = 8.68033f)
                lineTo(x = 14.85f, y = 8.15f)
                lineTo(x = 14.3197f, y = 7.61967f)
                lineTo(x = 10.4697f, y = 11.4697f)
                lineTo(x = 11.0f, y = 12.0f)
                close()
            }
        }.build().also { _bookmarkCheck = it }
    }
