    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                curveTo(x1 = 15.0f, y1 = 10.7508f, x2 = 14.8747f, y2 = 10.9849f, x3 = 14.666f, y3 = 11.124f)
                ...
                curveTo(x1 = 11.25f, y1 = 11.7492f, x2 = 11.3753f, y2 = 11.5151f, x3 = 11.584f, y3 = 11.376f)
                lineTo(x = 13.5f, y = 10.0986f)
                verticalLineTo(y = 8.5f)
                horizontalLineTo(x = 10.5f)
                verticalLineTo(y = 9.25f)
                curveTo(x1 = 10.5f, y1 = 9.66421f, x2 = 10.1642f, y2 = 10.0f, x3 = 9.75f, y3 = 10.0f)
                curveTo(x1 = 9.33579f, y1 = 10.0f, x2 = 9.0f, y2 = 9.66421f, x3 = 9.0f, y3 = 9.25f)
                verticalLineTo(y = 7.75f)
                close()
                moveTo(x = 12.0f, y = 15.0f)
                curveTo(x1 = 11.4477f, y1 = 15.0f, x2 = 11.0f, y2 = 15.4477f, x3 = 11.0f, y3 = 16.0f)
                curveTo(x1 = 11.0f, y1 = 16.5523f, x2 = 11.4477f, y2 = 17.0f, x3 = 12.0f, y3 = 17.0f)
                curveTo(x1 = 12.5523f, y1 = 17.0f, x2 = 13.0f, y2 = 16.5523f, x3 = 13.0f, y3 = 16.0f)
                curveTo(x1 = 13.0f, y1 = 15.4477f, x2 = 12.5523f, y2 = 15.0f, x3 = 12.0f, y3 = 15.0f)
                close()
            }
        }.build().also { _circleQuestionmark = it }
    }
