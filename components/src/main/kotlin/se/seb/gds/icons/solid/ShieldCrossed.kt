    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                curveTo(x1 = 13.9863f, y1 = 14.5721f, x2 = 14.4611f, y2 = 14.5734f, x3 = 14.7548f, y3 = 14.2812f)
                curveTo(x1 = 15.0484f, y1 = 13.9891f, x2 = 15.0497f, y2 = 13.5142f, x3 = 14.7575f, y3 = 13.2206f)
                lineTo(x = 13.046f, y = 11.5001f)
                lineTo(x = 14.7576f, y = 9.77943f)
                curveTo(x1 = 15.0497f, y1 = 9.48576f, x2 = 15.0484f, y2 = 9.01089f, x3 = 14.7548f, y3 = 8.71878f)
                curveTo(x1 = 14.4611f, y1 = 8.42666f, x2 = 13.9862f, y2 = 8.42793f, x3 = 13.6941f, y3 = 8.7216f)
                lineTo(x = 11.9881f, y = 10.4367f)
                lineTo(x = 10.2817f, y = 8.72135f)
                curveTo(x1 = 9.98958f, y1 = 8.42769f, x2 = 9.51471f, y2 = 8.42646f, x3 = 9.22105f, y3 = 8.71859f)
                curveTo(x1 = 8.9274f, y1 = 9.01071f, x2 = 8.92616f, y2 = 9.48559f, x3 = 9.21829f, y3 = 9.77924f)
                lineTo(x = 10.9303f, y = 11.5002f)
                lineTo(x = 9.21826f, y = 13.2214f)
                curveTo(x1 = 8.92615f, y1 = 13.5151f, x2 = 8.92741f, y2 = 13.9899f, x3 = 9.22109f, y3 = 14.282f)
                curveTo(x1 = 9.51476f, y1 = 14.5742f, x2 = 9.98963f, y2 = 14.5729f, x3 = 10.2817f, y3 = 14.2792f)
