    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                curveTo(x1 = 22.0022f, y1 = 14.6642f, x2 = 21.6664f, y2 = 15.0f, x3 = 21.2522f, y3 = 15.0f)
                horizontalLineTo(x = 18.0022f)
                verticalLineTo(y = 18.25f)
                curveTo(x1 = 18.0022f, y1 = 18.6642f, x2 = 17.6664f, y2 = 19.0f, x3 = 17.2522f, y3 = 19.0f)
                horizontalLineTo(x = 10.6965f)
                lineTo(x = 6.36643f, y = 21.4056f)
                curveTo(x1 = 6.13413f, y1 = 21.5347f, x2 = 5.85088f, y2 = 21.5312f, x3 = 5.62185f, y3 = 21.3964f)
                curveTo(x1 = 5.39282f, y1 = 21.2616f, x2 = 5.2522f, y2 = 21.0157f, x3 = 5.2522f, y3 = 20.75f)
                ...
                curveTo(x1 = 2.0022f, y1 = 7.33579f, x2 = 2.33798f, y2 = 7.0f, x3 = 2.7522f, y3 = 7.0f)
                horizontalLineTo(x = 6.2522f)
                verticalLineTo(y = 3.75f)
                curveTo(x1 = 6.2522f, y1 = 3.33579f, x2 = 6.58798f, y2 = 3.0f, x3 = 7.0022f, y3 = 3.0f)
                horizontalLineTo(x = 21.2522f)
                close()
                moveTo(x = 7.7522f, y = 7.0f)
                horizontalLineTo(x = 17.2522f)
                curveTo(x1 = 17.6664f, y1 = 7.0f, x2 = 18.0022f, y2 = 7.33579f, x3 = 18.0022f, y3 = 7.75f)
