...
internal val PageAdd: ImageVector
    get() {
        val current = _pageAdd
        if (current != null) return current

        return ImageVector.Builder(
            name = "se.seb.gds.theme.GdsTheme.PageAdd",
            ...
            path(
                ...
                verticalLineTo(y = 13.8357f)
                curveTo(x1 = 19.5875f, y1 = 13.3259f, x2 = 18.9568f, y2 = 13.0f, x3 = 18.25f, y3 = 13.0f)
                curveTo(x1 = 17.0074f, y1 = 13.0f, x2 = 16.0f, y2 = 14.0074f, x3 = 16.0f, y3 = 15.25f)
                ...
                curveTo(x1 = 16.0f, y1 = 21.513f, x2 = 16.0451f, y2 = 21.7654f, x3 = 16.128f, y3 = 22.0f)
                horizontalLineTo(x = 4.75f)
                curveTo(x1 = 4.33579f, y1 = 22.0f, x2 = 4.0f, y2 = 21.6642f, x3 = 4.0f, y3 = 21.25f)
                verticalLineTo(y = 2.75f)
                close()
                moveTo(x = 8.0f, y = 6.75f)
                curveTo(x1 = 8.0f, y1 = 6.33579f, x2 = 8.33579f, y2 = 6.0f, x3 = 8.75f, y3 = 6.0f)
                horizontalLineTo(x = 15.25f)
                curveTo(x1 = 15.6642f, y1 = 6.0f, x2 = 16.0f, y2 = 6.33579f, x3 = 16.0f, y3 = 6.75f)
                curveTo(x1 = 16.0f, y1 = 7.16421f, x2 = 15.6642f, y2 = 7.5f, x3 = 15.25f, y3 = 7.5f)
                horizontalLineTo(x = 8.75f)
                curveTo(x1 = 8.33579f, y1 = 7.5f, x2 = 8.0f, y2 = 7.16421f, x3 = 8.0f, y3 = 6.75f)
                close()
                moveTo(x = 8.0f, y = 10.75f)
                curveTo(x1 = 8.0f, y1 = 10.3358f, x2 = 8.33579f, y2 = 10.0f, x3 = 8.75f, y3 = 10.0f)
                horizontalLineTo(x = 11.25f)
                curveTo(x1 = 11.6642f, y1 = 10.0f, x2 = 12.0f, y2 = 10.3358f, x3 = 12.0f, y3 = 10.75f)
                curveTo(x1 = 12.0f, y1 = 11.1642f, x2 = 11.6642f, y2 = 11.5f, x3 = 11.25f, y3 = 11.5f)
                horizontalLineTo(x = 8.75f)
                curveTo(x1 = 8.33579f, y1 = 11.5f, x2 = 8.0f, y2 = 11.1642f, x3 = 8.0f, y3 = 10.75f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000)),
