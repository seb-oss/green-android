    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveTo(x = 15.9096f, y = 8.8456f)
                curveTo(x1 = 16.1008f, y1 = 8.75421f, x2 = 16.2349f, y2 = 8.59617f, x3 = 16.2709f, y3 = 8.38983f)
                curveTo(x1 = 16.3075f, y1 = 8.18444f, x2 = 16.243f, y2 = 7.94761f, x3 = 16.1032f, y3 = 7.74786f)
                curveTo(x1 = 15.9633f, y1 = 7.54811f, x2 = 15.7628f, y2 = 7.40654f, x3 = 15.5573f, y3 = 7.37072f)
                curveTo(x1 = 15.3511f, y1 = 7.33394f, x2 = 15.1567f, y2 = 7.40589f, x3 = 15.0054f, y3 = 7.5543f)
                curveTo(x1 = 14.9681f, y1 = 7.59045f, x2 = 14.9336f, y2 = 7.62465f, x3 = 14.8963f, y3 = 7.66075f)
                curveTo(x1 = 14.2444f, y1 = 8.29763f, x2 = 13.5915f, y2 = 8.93523f, x3 = 12.9396f, y3 = 9.57211f)
                curveTo(x1 = 12.9024f, y1 = 9.60821f, x2 = 12.8678f, y2 = 9.64241f, x3 = 12.8305f, y3 = 9.67856f)
                curveTo(x1 = 12.7824f, y1 = 9.72582f, x2 = 12.7535f, y2 = 9.7959f, x3 = 12.7466f, y3 = 9.86816f)
                curveTo(x1 = 12.74f, y1 = 9.94071f, x2 = 12.7559f, y2 = 10.0095f, x3 = 12.7945f, y3 = 10.0646f)
                curveTo(x1 = 12.8331f, y1 = 10.1198f, x2 = 12.8923f, y2 = 10.1582f, x3 = 12.9627f, y3 = 10.1768f)
                curveTo(x1 = 13.033f, y1 = 10.1951f, x2 = 13.1087f, y2 = 10.1919f, x3 = 13.1696f, y3 = 10.1628f)
                curveTo(x1 = 13.2163f, y1 = 10.1401f, x2 = 13.2603f, y2 = 10.1194f, x3 = 13.3069f, y3 = 10.0967f)
                curveTo(x1 = 14.1284f, y1 = 9.70195f, x2 = 14.9508f, y2 = 9.30646f, x3 = 15.7723f, y3 = 8.9117f)
                curveTo(x1 = 15.8189f, y1 = 8.88905f, x2 = 15.8629f, y2 = 8.8683f, x3 = 15.9096f, y3 = 8.8456f)
                close()
            }
            path(
                stroke = SolidColor(Color(0xFF000000)),
