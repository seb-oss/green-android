...
internal val ReceiptBill: ImageVector
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                curveTo(x1 = 20.0f, y1 = 21.544f, x2 = 19.8283f, y2 = 21.8108f, x3 = 19.5607f, y3 = 21.9326f)
                curveTo(x1 = 19.2931f, y1 = 22.0544f, x2 = 18.9791f, y2 = 22.0086f, x3 = 18.7574f, y3 = 21.8156f)
                lineTo(x = 16.6924f, y = 20.017f)
                lineTo(x = 14.8539f, y = 21.7899f)
                curveTo(x1 = 14.5634f, y1 = 22.07f, x2 = 14.1033f, y2 = 22.07f, x3 = 13.8127f, y3 = 21.7899f)
                lineTo(x = 12.0f, y = 20.0419f)
                lineTo(x = 10.1873f, y = 21.7899f)
                curveTo(x1 = 9.89674f, y1 = 22.07f, x2 = 9.4366f, y2 = 22.07f, x3 = 9.14606f, y3 = 21.7899f)
                lineTo(x = 7.30756f, y = 20.017f)
                lineTo(x = 5.24259f, y = 21.8156f)
                curveTo(x1 = 5.02091f, y1 = 22.0086f, x2 = 4.70687f, y2 = 22.0544f, x3 = 4.43931f, y3 = 21.9326f)
                curveTo(x1 = 4.17175f, y1 = 21.8108f, x2 = 4.0f, y2 = 21.544f, x3 = 4.0f, y3 = 21.25f)
                ...
                curveTo(x1 = 11.6642f, y1 = 11.0f, x2 = 12.0f, y2 = 11.3358f, x3 = 12.0f, y3 = 11.75f)
                curveTo(x1 = 12.0f, y1 = 12.1642f, x2 = 11.6642f, y2 = 12.5f, x3 = 11.25f, y3 = 12.5f)
                horizontalLineTo(x = 8.75f)
