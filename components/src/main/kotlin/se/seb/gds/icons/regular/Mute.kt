    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                close()
                moveTo(x = 7.43934f, y = 15.5f)
                horizontalLineTo(x = 6.5f)
                verticalLineTo(y = 8.5f)
                horizontalLineTo(x = 10.0f)
                curveTo(x1 = 10.1433f, y1 = 8.5f, x2 = 10.2836f, y2 = 8.45895f, x3 = 10.4043f, y3 = 8.3817f)
                lineTo(x = 15.5f, y = 5.12045f)
                verticalLineTo(y = 7.43934f)
                lineTo(x = 7.43934f, y = 15.5f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                moveTo(x = 15.5f, y = 18.8796f)
                lineTo(x = 11.1102f, y = 16.0701f)
                lineTo(x = 10.0243f, y = 17.156f)
                lineTo(x = 15.8457f, y = 20.8817f)
                curveTo(x1 = 16.0766f, y1 = 21.0294f, x2 = 16.3696f, y2 = 21.0395f, x3 = 16.6101f, y3 = 20.9079f)
                curveTo(x1 = 16.8505f, y1 = 20.7763f, x2 = 17.0f, y2 = 20.5241f, x3 = 17.0f, y3 = 20.25f)
                verticalLineTo(y = 10.1803f)
                lineTo(x = 15.5f, y = 11.6803f)
                verticalLineTo(y = 18.8796f)
                close()
            }
        }.build().also { _mute = it }
    }
