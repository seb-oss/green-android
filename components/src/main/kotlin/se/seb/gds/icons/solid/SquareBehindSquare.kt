...
val SquareBehindSquare: ImageVector
    get() {
        val current = _squareBehindSquare
        if (current != null) return current

        return ImageVector.Builder(
            name = "se.seb.gds.theme.GdsTheme.SquareBehindSquare",
            ...
            path(
                ...
                verticalLineTo(y = 15.51f)
                horizontalLineTo(x = 17.0f)
                close()
            }
        }.build().also { _squareBehindSquare = it }
    }
...
private var _squareBehindSquare: ImageVector? = null
