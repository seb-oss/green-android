    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                curveTo(x1 = 21.6642f, y1 = 14.0f, x2 = 22.0f, y2 = 13.6642f, x3 = 22.0f, y3 = 13.25f)
                verticalLineTo(y = 3.75f)
                curveTo(x1 = 22.0f, y1 = 3.33579f, x2 = 21.6642f, y2 = 3.0f, x3 = 21.25f, y3 = 3.0f)
                horizontalLineTo(x = 6.58563f)
                curveTo(x1 = 4.73288f, y1 = 3.0f, x2 = 3.15846f, y2 = 4.35403f, x3 = 2.87984f, y3 = 6.1859f)
                lineTo(x = 2.04331f, y = 11.6859f)
                curveTo(x1 = 1.69817f, y1 = 13.9552f, x2 = 3.45378f, y2 = 16.0f, x3 = 5.74911f, y3 = 16.0f)
                horizontalLineTo(x = 10.1133f)
                lineTo(x = 9.67283f, y = 18.8264f)
                curveTo(x1 = 9.41305f, y1 = 20.4935f, x2 = 10.7015f, y2 = 22.0f, x3 = 12.389f, y3 = 22.0f)
                horizontalLineTo(x = 13.0043f)
                curveTo(x1 = 13.2852f, y1 = 22.0f, x2 = 13.5425f, y2 = 21.8431f, x3 = 13.6711f, y3 = 21.5933f)
