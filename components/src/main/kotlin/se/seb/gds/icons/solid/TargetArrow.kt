    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                curveTo(x1 = 18.3884f, y1 = 1.5245f, x2 = 18.1804f, y2 = 1.33039f, x3 = 17.9207f, y3 = 1.26969f)
                curveTo(x1 = 17.6609f, y1 = 1.20899f, x2 = 17.3885f, y2 = 1.29083f, x3 = 17.2051f, y3 = 1.48462f)
                lineTo(x = 13.7051f, y = 5.18462f)
                curveTo(x1 = 13.5734f, y1 = 5.32388f, x2 = 13.5f, y2 = 5.50831f, x3 = 13.5f, y3 = 5.70002f)
                verticalLineTo(y = 9.43936f)
                lineTo(x = 11.4697f, y = 11.4697f)
                curveTo(x1 = 11.1768f, y1 = 11.7626f, x2 = 11.1768f, y2 = 12.2375f, x3 = 11.4697f, y3 = 12.5303f)
                ...
                curveTo(x1 = 22.7092f, y1 = 6.61156f, x2 = 22.791f, y2 = 6.33911f, x3 = 22.7303f, y3 = 6.07935f)
                curveTo(x1 = 22.6696f, y1 = 5.8196f, x2 = 22.4755f, y2 = 5.61163f, x3 = 22.2206f, y3 = 5.53318f)
            ...
            path(
                ...
                curveTo(x1 = 11.8154f, y1 = 7.08348f, x2 = 11.5501f, y2 = 7.47732f, x3 = 11.1435f, y3 = 7.55659f)
                curveTo(x1 = 9.06706f, y1 = 7.96145f, x2 = 7.5f, y2 = 9.79157f, x3 = 7.5f, y3 = 11.9861f)
                curveTo(x1 = 7.5f, y1 = 14.4785f, x2 = 9.52054f, y2 = 16.4991f, x3 = 12.013f, y3 = 16.4991f)
                curveTo(x1 = 14.2075f, y1 = 16.4991f, x2 = 16.0376f, y2 = 14.932f, x3 = 16.4425f, y3 = 12.8556f)
                curveTo(x1 = 16.5217f, y1 = 12.4491f, x2 = 16.9156f, y2 = 12.1838f, x3 = 17.3221f, y3 = 12.263f)
                curveTo(x1 = 17.7287f, y1 = 12.3423f, x2 = 17.994f, y2 = 12.7361f, x3 = 17.9147f, y3 = 13.1427f)
                curveTo(x1 = 17.3751f, y1 = 15.9102f, x2 = 14.9388f, y2 = 17.9991f, x3 = 12.013f, y3 = 17.9991f)
                curveTo(x1 = 8.69211f, y1 = 17.9991f, x2 = 6.0f, y2 = 15.307f, x3 = 6.0f, y3 = 11.9861f)
                curveTo(x1 = 6.0f, y1 = 9.06021f, x2 = 8.08896f, y2 = 6.62391f, x3 = 10.8565f, y3 = 6.08431f)
                curveTo(x1 = 11.263f, y1 = 6.00505f, x2 = 11.6569f, y2 = 6.27037f, x3 = 11.7361f, y3 = 6.67693f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000)),
                ...
                curveTo(x1 = 13.271f, y1 = 2.38955f, x2 = 12.9535f, y2 = 2.03638f, x3 = 12.5399f, y3 = 2.01434f)
