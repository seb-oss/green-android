    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                curveTo(x1 = 13.7225f, y1 = 3.5f, x2 = 15.1558f, y2 = 4.7451f, x3 = 15.4462f, y3 = 6.38452f)
                curveTo(x1 = 15.5184f, y1 = 6.79239f, x2 = 15.9076f, y2 = 7.06446f, x3 = 16.3155f, y3 = 6.99222f)
                curveTo(x1 = 16.7234f, y1 = 6.91997f, x2 = 16.9954f, y2 = 6.53076f, x3 = 16.9232f, y3 = 6.1229f)
                curveTo(x1 = 16.5081f, y1 = 3.77964f, x2 = 14.4627f, y2 = 2.0f, x3 = 12.0f, y3 = 2.0f)
                close()
