    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                curveTo(x1 = 10.6334f, y1 = 2.75f, x2 = 9.41741f, y2 = 3.39504f, x3 = 8.63994f, y3 = 4.39727f)
                moveTo(x = 3.0f, y = 3.0f)
                lineTo(x = 7.75f, y = 7.75f)
                moveTo(x = 7.75f, y = 7.75f)
                verticalLineTo(y = 11.5f)
                curveTo(x1 = 7.75f, y1 = 13.8472f, x2 = 9.65279f, y2 = 15.75f, x3 = 12.0f, y3 = 15.75f)
                curveTo(x1 = 13.0463f, y1 = 15.75f, x2 = 14.0043f, y2 = 15.3719f, x3 = 14.7449f, y3 = 14.7449f)
                moveTo(x = 7.75f, y = 7.75f)
                ...
                curveTo(x1 = 8.92453f, y1 = 19.0f, x2 = 6.2814f, y2 = 17.1489f, x3 = 5.12407f, y3 = 14.5f)
                moveTo(x = 12.0f, y = 19.0f)
                verticalLineTo(y = 21.25f)
                moveTo(x = 12.0f, y = 19.0f)
                curveTo(x1 = 13.9439f, y1 = 19.0f, x2 = 15.715f, y2 = 18.2605f, x3 = 17.0474f, y3 = 17.0474f)
            }
