...
internal val Scissors: ImageVector
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                lineTo(x = 22.0675f, y = 5.94277f)
                curveTo(x1 = 21.409f, y1 = 5.63006f, x2 = 20.6325f, y2 = 5.70039f, x3 = 20.041f, y3 = 6.12633f)
            ...
            path(
                ...
                moveTo(x = 22.0675f, y = 18.0572f)
                curveTo(x1 = 21.409f, y1 = 18.3699f, x2 = 20.6325f, y2 = 18.2996f, x3 = 20.041f, y3 = 17.8737f)
                lineTo(x = 14.4502f, y = 13.8483f)
                lineTo(x = 15.7338f, y = 12.9242f)
                lineTo(x = 22.5469f, y = 17.8296f)
                lineTo(x = 22.0675f, y = 18.0572f)
                close()
            }
        }.build().also { _scissors = it }
    }
