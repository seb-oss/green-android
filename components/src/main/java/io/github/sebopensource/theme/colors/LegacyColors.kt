package io.github.sebopensource.theme.colors
...
data class LegacyColors(
    ...
    companion object {
        private val defaultLightColors = LegacyColors(
            isDark = false,
        ...
        private val defaultDarkColors = LegacyColors(
            isDark = true,
...
data class UtilityColors(val UtilityTestColor: Color) {
    companion object {
        private val lightColors = UtilityColors(
            UtilityTestColor = Color.Black,
        )

        private val darkColors = UtilityColors(
